...
def open_application(app_name: str) -> str:
    ...
    if _is_android():
        return f"Please open {app_name} manually on your Android device."
...
def close_application(app_name: str) -> str:
    ...
    if _is_android():
        return "Closing applications is managed by the Android system."
    import psutil
    try:
        closed = False
...
def control_media(command: str, track_query: str = "") -> str:
    ...
    if _is_android():
        return "Media playback control is managed by the media apps on your Android device."
    os_name = platform.system()
...
def messaging_tool(platform: str, recipient: str = "", message: str = "") -> str:
    ...
    if _is_android():
        return f"Please launch the {platform} application on your Android device to send this message."
    import urllib.parse
